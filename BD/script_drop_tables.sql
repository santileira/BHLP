...
DROP PROCEDURE  [ABSTRACCIONX4].ModificarPeriodosFS
...
DROP FUNCTION [ABSTRACCIONX4].RespetaOrigenesDestinos
DROP PROCEDURE  [ABSTRACCIONX4].ReasignarButacas

DROP FUNCTION [ABSTRACCIONX4].ExisteRuta
