...
CREATE TABLE [ABSTRACCIONX4].[RUTAS_AEREAS](
	...
	[RUTA_ESTADO] [int] NULL, --para su baja lógica
...
ALTER TABLE [ABSTRACCIONX4].[PASAJES]  WITH CHECK ADD  CONSTRAINT [FK_PASAJES_CLIENTES] FOREIGN KEY([CLI_DNI])
REFERENCES [ABSTRACCIONX4].[CLIENTES] ([CLI_DNI])
...
ALTER TABLE [ABSTRACCIONX4].[ENCOMIENDAS]  WITH CHECK ADD  CONSTRAINT [FK_ENCOMIENDAS_CLIENTES] FOREIGN KEY([CLI_DNI])
REFERENCES [ABSTRACCIONX4].[CLIENTES] ([CLI_DNI])
...
ALTER TABLE [ABSTRACCIONX4].[CANJES]  WITH CHECK ADD  CONSTRAINT [FK_CANJES_CLIENTES] FOREIGN KEY([CLI_DNI])
REFERENCES [ABSTRACCIONX4].[CLIENTES] ([CLI_DNI])
